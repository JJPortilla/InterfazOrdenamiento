...
public class interfazOrdenamiento extends JFrame {
	...
	private static final Object anchor = null;
	...
	public interfazOrdenamiento() {
		...
		textArregloOrdenado.setBounds(63, 200, 373, 341);
		contentPane.add(textArregloOrdenado);

		JButton btnOrdenBurbuja = new JButton("Burbuja");
		btnOrdenBurbuja.setBounds(446, 202, 85, 21);
		...
		btnSeleccion.setBounds(446, 233, 85, 21);
		...
		btnInsercion.setBounds(446, 264, 85, 21);
		...
		btnBurbujaMejorado.setBounds(446, 294, 85, 21);
	...
	private void ingresarTamano() {
		try {
			...
			JOptionPane.showMessageDialog(this, "Ingrese un tamaño válido (número entero positivo)");
		}
	}
	...
	private void ingresarDatos() {
		try {
			...
			if (valoresStr.length != tamano) {
				throw new Exception("Número de valores no coincide con el tamaño del arreglo");
			}
